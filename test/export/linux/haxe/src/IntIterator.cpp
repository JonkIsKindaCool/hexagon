...
HX_DEFINE_STACK_FRAME(_hx_pos_38f1b201f6b11cab_45_new,"IntIterator","new",0x5692054f,"IntIterator.new","/usr/share/haxe/std/IntIterator.hx",45,0x062523fc)
HX_LOCAL_STACK_FRAME(_hx_pos_38f1b201f6b11cab_54_hasNext,"IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","/usr/share/haxe/std/IntIterator.hx",54,0x062523fc)
HX_LOCAL_STACK_FRAME(_hx_pos_38f1b201f6b11cab_63_next,"IntIterator","next",0x6932a124,"IntIterator.next","/usr/share/haxe/std/IntIterator.hx",63,0x062523fc)

void IntIterator_obj::__construct(int min,int max){
            	HX_STACKFRAME(&_hx_pos_38f1b201f6b11cab_45_new)
...
bool IntIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_38f1b201f6b11cab_54_hasNext)
...
int IntIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_38f1b201f6b11cab_63_next)
