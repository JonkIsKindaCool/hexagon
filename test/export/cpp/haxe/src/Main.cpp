...
HXLINE(   5)		::haxe::Log_obj::trace(HX_("aea",fd,f2,49,00),::hx::SourceInfo(HX_("src/Main.hx",9a,7a,30,a1),5,HX_("Main",59,64,2f,33),HX_("new",60,d0,53,00)));
HXLINE(   8)		::haxe::Log_obj::trace(HX_("debugged",13,24,eb,90),::hx::SourceInfo(HX_("src/Main.hx",9a,7a,30,a1),8,HX_("Main",59,64,2f,33),HX_("new",60,d0,53,00)));
            	}
