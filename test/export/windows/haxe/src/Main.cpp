...
void Main_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_5_new)
HXDLIN(   5)		::haxe::Log_obj::trace(HX_("aea",fd,f2,49,00),::hx::SourceInfo(HX_("src/Main.hx",9a,7a,30,a1),5,HX_("Main",59,64,2f,33),HX_("new",60,d0,53,00)));
            	}
